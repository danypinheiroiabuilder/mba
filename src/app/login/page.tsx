          ...
          >
            {!configOk && (
              <div
                role="alert"
                aria-live="polite"
                className="rounded-2xl border border-border bg-card/30 px-3 py-2 text-sm text-muted"
              >
            ...
            {message && (
              <div
                role="alert"
                aria-live="polite"
                className="mt-4 rounded-2xl border border-border bg-card/30 px-3 py-2 text-sm text-muted"
              >
                {message}
              </div>
            )}
